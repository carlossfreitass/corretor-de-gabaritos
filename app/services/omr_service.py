...
from utils.image_utils import convert_to_gray, threshold_otsu
...
def isolar_caixa_respostas(imagem):
    ...
    # DETECÇÃO DA CAIXA DE RESPOSTAS
...
def corrigir_gabarito(file, gabarito_oficial, valor_prova=10.0, pesos=None):
    from services.resultado_service import processar_resultado_final
